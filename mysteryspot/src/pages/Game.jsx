...
// import hardBg from "../assets/scene5.webp";
...
//   const levelSettings = {
//     easy: { clues: 5, time: 300, bg: easyBg, hints: 8 },
//     medium: { clues: 7, time: 180, bg: mediumBg, hints: 6 },
//     hard: { clues: 10, time: 120, bg: hardBg, hints: 4 },
//   };
...
//     levelSelect.play();
//     setLevel(lvl);
//     generateClues(levelSettings[lvl].clues);
...
//                   className={`absolute w-6 h-6 md:w-8 md:h-8 cursor-pointer rounded-full ${
...
//   const generateClues = (count) => {
//     let id = count === 5 ? 2 : count === 7 ? 1 : 3;
//     // 🔑 convert x,y into percentage of ORIGINAL image size
      ...
      {gameOver && (
        ...
        >
          ...
          <p className="text-yellow-200 text-lg md:text-2xl font-bold mb-8">
            {console.log(`information username-${username} level-${level} score-${score}`)}
            {saveBestScore(username, level, score)}
