// //..............................................................................................
// //see Comment to find any particular gaming related stuff
...
//     const radius = 40; // 👈 tolerance for click (pixels)
...
//                 //     clue.found ? "bg-green-600/80" : "bg-transparent"
//                 //   }`}
//                 //   style={{ top, left }}
//                 //   animate={activeHint === clue.id ? { scale: [1, 1.5, 1] } : {}}
//                 // />
...
//             {console.log(
//               `information username-${username} level-${level} score-${score} time:${
...
//                 //   key={clue.id}
//                 //   className={`absolute w-6 h-6 md:w-10 md:h-10 rounded-full ${
//                 //     clue.found ? "bg-green-600/80" : "bg-red-600/80"
//                 //   }`}
//                 //   style={{ top, left }}
//                 //   animate={activeHint === clue.id ? { scale: [1, 1.5, 1] } : {}}
//                 // />
